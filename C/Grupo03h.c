...
int aproximarLinea(struct NumerosQ m, struct NumerosQ b){ 
  /* Elemento extra que no terminamos de implementar ,
  el objetivo de esta funcion es tomar la aproximacion que hicimos y poder representar
  que tan cerca de la recta real estamos usando Octave*/
  int cant = 0;
